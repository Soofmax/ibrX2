        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-stone-200 hover:shadow-2xl transition-all">
            ...
            <form className="space-y-3">
              <input
                className="w-full px-4 py-3 rounded-xl border border-stone-200 font-serif focus-ring text-stone-900"
              ...
              <button
                type="button"
                className="bg-stone-900 hover:bg-stone-800 text-amber-50 font-serif px-6 py-3 rounded-full transition-all hover:scale-105 shadow-xl focus-ring"
              >
                {t('contact.send')}
              </button>
            </form>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-stone-200 hover:shadow-2xl transition-all">
            ...
            <ul className="space-y-3 text-stone-700 font-serif">
              <li>
                <strong className="font-handwritten text-stone-900">{t('contact.q1')}</strong>
                <br />
                {t('contact.a1')}
              </li>
              <li>
                <strong className="font-handwritten text-stone-900">{t('contact.q2')}</strong>
                <br />
                {t('contact.a2')}
              </li>
              <li>
                <strong className="font-handwritten text-stone-900">{t('contact.q3')}</strong>
                <br />
                {t('contact.a3')}
              </li>
              <li>
                <strong className="font-handwritten text-stone-900">
              ...
              <li>
                <strong className="font-handwritten text-stone-900">Comment soutenir ?</strong>
                <br />
