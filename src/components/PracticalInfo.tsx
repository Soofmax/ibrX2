      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-stone-200 hover:shadow-2xl transition-all">
            <h3 className="text-2xl font-handwritten text-lime-800 mb-3">
              {t('practical.resources')}
            </h3>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-stone-200 hover:shadow-2xl transition-all">
            ...
            <p className="text-stone-700 font-serif">
              Carnet de Passages (~500 €/véhicule), permis C (PTAC &gt; 7,5 t) et PCI, visas
              anticipés (ex: Chine/Soudan) avec guides locaux si requis.
            </p>
          </div>
