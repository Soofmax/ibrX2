...
export default function PracticalInfo() {
  ...
  return (
    <section id="practical" className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-stone-100 to-green-50 relative overflow-hidden scroll-mt-24">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-stone-200 hover:shadow-2xl transition-all">
            ...
            <ul className="space-y-2 text-stone-700 font-serif">
             <<li> <<a href="https://expeditionportal.com" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">Expedition Port</<></</li>
             <<li> <<a href="https://www.ioverlander.com" target="_blank" rel="noopener noreferrer" className="text-green-700 hover:underline">iOverland</<></</li>
