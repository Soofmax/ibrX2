    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-stone-600 font-serif">{t('sponsors.tagline')}</p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-stone-200 hover:shadow-2xl transition-all">
            ...
            <div className="flex flex-wrap gap-3 mt-6">
              ...
              <button
                type="button"
                onClick={() => navigate('/sponsor-targets')}
                className="inline-block bg-amber-600 hover:bg-amber-700 text-white font-serif px-6 py-3 rounded-full transition-all hover:scale-105 shadow-xl focus-ring"
              >
                {t('nav.targets')}
              </button>
            </div>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-stone-200 hover:shadow-2xl transition-all">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h3 className="text-2xl font-handwritten text-stone-900">
                {t('sponsors.shopTitle')}
              </h3>
            </div>
            <p className="text-stone-700 font-serif">{t('sponsors.shopText')}</p>
          </div>
        </div>
      </div>
    </section>
