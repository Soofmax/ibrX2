...
export default function Logistics() {
  ...
  return (
    <section id="logistics" className="py-24 px-4 sm:px-6 lg:px-8 bg-green-50 relative overflow-hidden scroll-mt-24">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          <div className="inline-block mb-4">
            <ShieldAlert className="text-green-600 mx-auto" size={48} />
          </div>
