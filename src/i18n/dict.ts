export const fr = {
  ...
  'nav.support': 'Soutien',
  'nav.donations': 'Soutenir l’expédition',
  ...
  'countdown.year': 'année',
  'countdown.months': 'mois',
  'countdown.month': 'mois',
  ...
  'support.vehicleStatusTitle': 'Statut des véhicules',
  'support.simulationBadge': 'Mode Simulation : les paiements ne sont pas réels pour le moment.',
...
export const en: Dict = {
  ...
  'nav.sponsors': 'Sponsors',
  'nav.support': 'Support',
  'nav.donations': 'Support the Expedition',
  ...
  'support.vehicleStatusTitle': 'Vehicle Status',
  'support.simulationBadge': 'Simulation Mode: payments are not real for now.',
